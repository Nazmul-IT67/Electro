...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/vendor/fonts/material-design-iconic-font/css/aterialdesignicons.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/vendor/charts/c3charts/c3.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/vendor/fonts/flag-icon-css/flag-icon.min.css') }}">
    <title>E_Commerce Dashboard Template</title>
    <link rel="icon" type="image/x-icon" href="https://cu1.uicdn.net/230/4c9659593b3d5c4113e4ac8fa7ece/webapp/33925-n-stage-nlement_blank-int.png">
</head>
                        ...
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown"
                                ...
                                <div class="nav-user-info">
                                    <h5 class="mb-0 text-white nav-user-name">{{ $usersdata->name ?? 'N/A' }}</h5>
                                </div>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link @yield('dashboard')" href="{{ route('Dashboard') }}"><i class="fas fa-home"></i>Dashboard</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link  @yield('Category')" href="#" data-toggle="collapse" aria-expanded="false"
                                    data-target="#submenu-2" aria-controls="submenu-2">
                                    <i class="fa fa-fw fa-rocket"></i>Category
                                </a>
                                <div id="submenu-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ url('trashlist') }}">Trash Data</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link @yield('SubCategory')" href="#" data-toggle="collapse" aria-expanded="false"
                                    data-target="#submenu-3" aria-controls="submenu-3"><i
                                        class="fas fa-fw fa-chart-pie"></i>Sub-Category</a>
                                <div id="submenu-3" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('SubCategory') }}">Add SubCategory</a>
                                        </li>
                                        <li class="nav-item">
