            ...
            <div class="container-fluid dashboard-content">
                ...
                <div class="ecommerce-widget">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <h5 class="card-header">Category Table({{ $t_count }})</h5>
                                <div class="card-body">
                                    @if (session('success'))
                                        <div class="col-sm-12">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <a class="btn btn-sm btn-info btn-rounded" href="{{ route('Restor', $data->id)}}"><i class="fas fa-edit"></i>Restor</a>
                                                    <a class="btn btn-sm btn-warning btn-rounded" href="{{ route('Delete', $data->id) }}"><i class="fas fa-trash"></i> Delete</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
