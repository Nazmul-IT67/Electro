                                ...
                                <div class="card-body">
                                    <form action="{{ route('CategoryUpdate') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="category_name" type="text" name="category_name" placeholder="Enter category name" class="form-control @error('category_name') is-invalid @enderror" value="{{ $category->category_name ?? old('category_name') }}">
                                            @error('category_name')
